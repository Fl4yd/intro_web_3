...
function makeTable() {
  return _makeTable.apply(this, arguments);
}
function _makeTable() {
  _makeTable = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response1, response2, data, data2, labels, label_strings, key, values, values2, table_body, table_head, tr, th1, th2, th3, th4, idx, _tr, td1, td2, td3, td4, employment_rate;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 11:
          data2 = _context.sent;
          labels = data.dataset.dimension.Alue.category.label;
          label_strings = [];
          for (key in labels) {
          ...
          values2 = data2.dataset.value;
          table_body = document.getElementById('table-body');
          table_head = document.getElementById('table-head'); //Insert header data into the table
          ...
          for (idx = 0; idx < values.length; idx++) {
            ...
            employment_rate = Math.round(values2[idx] / values[idx] * 10000) / 100;
